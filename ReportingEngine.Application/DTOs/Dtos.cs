...
public sealed record DeliveryConfigurationDto(long DeliveryConfigId, string DeliveryName, string DeliveryType, string? DestinationReference, string? EmailTo, string? EmailCc, string? EmailBcc, string? EmailSubjectTemplate, string? EmailBodyTemplate, string? SecretReference, bool IsFailureNotification, bool IsActive);
public sealed record CreateDeliveryConfigurationRequest(string DeliveryName, string DeliveryType, string? DestinationReference, string? EmailTo, string? EmailCc, string? EmailBcc, string? EmailSubjectTemplate, string? EmailBodyTemplate, string? SecretReference, bool IsFailureNotification);
public sealed record UpdateDeliveryConfigurationRequest(string DeliveryName, string DeliveryType, string? DestinationReference, string? EmailTo, string? EmailCc, string? EmailBcc, string? EmailSubjectTemplate, string? EmailBodyTemplate, string? SecretReference, bool IsFailureNotification, bool IsActive);
