...
public sealed record DataSourceDto(long DataSourceId, string DataSourceName, string DataSourceType, string ConnectionReference, bool HasConnectionString, bool HasConfiguredConnection, bool IsActive);
...
public sealed record DeliveryConfigurationDto(long DeliveryConfigId, string DeliveryName, string DeliveryType, string? DestinationReference, string? EmailTo, string? EmailCc, string? EmailBcc, string? EmailSubjectTemplate, string? EmailBodyTemplate, string? SecretReference, long? SmtpConfigId, string? SmtpProfileName, bool IsFailureNotification, bool IsActive);
public sealed record CreateDeliveryConfigurationRequest(string DeliveryName, string DeliveryType, string? DestinationReference, string? EmailTo, string? EmailCc, string? EmailBcc, string? EmailSubjectTemplate, string? EmailBodyTemplate, string? SecretReference, long? SmtpConfigId, bool IsFailureNotification);
public sealed record UpdateDeliveryConfigurationRequest(string DeliveryName, string DeliveryType, string? DestinationReference, string? EmailTo, string? EmailCc, string? EmailBcc, string? EmailSubjectTemplate, string? EmailBodyTemplate, string? SecretReference, long? SmtpConfigId, bool IsFailureNotification, bool IsActive);

public sealed record SmtpConfigurationDto(long SmtpConfigId, string ProfileName, string Host, int Port, bool EnableSsl, string FromAddress, string FromDisplayName, string? UserName, bool HasPassword, int TimeoutSeconds, bool UseFileDrop, string? FileDropPath, bool IsActive);
public sealed record CreateSmtpConfigurationRequest(string ProfileName, string Host, int Port, bool EnableSsl, string FromAddress, string FromDisplayName, string? UserName, string? Password, int TimeoutSeconds, bool UseFileDrop, string? FileDropPath);
public sealed record UpdateSmtpConfigurationRequest(string ProfileName, string Host, int Port, bool EnableSsl, string FromAddress, string FromDisplayName, string? UserName, string? Password, int TimeoutSeconds, bool UseFileDrop, string? FileDropPath, bool IsActive);

public sealed record JobFailureNotificationProfileDto(long FailureProfileId, string ProfileName, long SmtpConfigId, string? SmtpProfileName, string EmailTo, string? EmailCc, string? EmailBcc, string? SubjectTemplate, string? BodyTemplate, bool IsActive);
public sealed record CreateJobFailureNotificationProfileRequest(string ProfileName, long SmtpConfigId, string EmailTo, string? EmailCc, string? EmailBcc, string? SubjectTemplate, string? BodyTemplate);
public sealed record UpdateJobFailureNotificationProfileRequest(string ProfileName, long SmtpConfigId, string EmailTo, string? EmailCc, string? EmailBcc, string? SubjectTemplate, string? BodyTemplate, bool IsActive);
